 ...
 ;(function ($, window, document) {
	...
	RS.prototype = {
        ...
        ,setThumbs: function () {
            ...
            var $div_wrapper = $('<div class="rs-thumb-wrap" />');
            var $div_container = $('<div class="rs-thumb-container"></div>');
            $div_container.appendTo($div_wrapper);
            $div_wrapper.appendTo(this.$sliderWrap);
            this.$thumbWrap = $div_container;
            ...
            for (var i = 0; i < this.totalSlides; i++) {
                ...
                var src = this.$slideImages.eq(i).attr('src');
